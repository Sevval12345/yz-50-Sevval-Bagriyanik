# bigram_counting1.py + bigram_counting2.py + bigram_counting3.py + bigram_counting4.py + bigram_counting5.py = bigram_counting.py
...
def build_probability_table(N, smoothing=0):
    ...
    log(0) = -inf durumunu onluyor. smoothing=0 ise hic smoothing yok.
...
def visualize_bigram_table(N, itos, vocab_size, save_path="bigram_table.png"):
    """
