...
def build_training_set(words, stoi):
    ...
    Bu, geçen gorevdeki NLL hesaplamasinda gezdigimiz ayni bigram'lar -
...
def init_weights(vocab_size, seed=2147483647):
    ...
    gecen hafta Value sinifinda grad alaninin otomatik doldurulmasiyla
    ayni amac.
    """
...
def compute_loss(probs, ys, W, reg_strength=0.01):
    ...
    W sifira yakin kaldikca, olasilik dagilimi daha uniform (duzgun) olur.
    """
    num = probs.shape[0]
...
def train(xs, ys, W, vocab_size, steps=200, learning_rate=50.0, reg_strength=0.01, verbose_every=20):
    """
    ADIM 3: Gradient descent dongusu - gecen hafta micrograd'da yazdigin
    backward() mekanizmasinin, PyTorch tarafindan buyuk tensorler
    uzerinde otomatik calistirilmis hali. Kavramsal olarak birebir ayni:
